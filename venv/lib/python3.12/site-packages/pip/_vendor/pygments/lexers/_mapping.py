...
LEXERS = {
    ...
    'AdaLexer': ('pip._vendor.pygments.lexers.ada', 'Ada', ('ada', 'ada95', 'ada2005'), ('*.aREMOVED', '*.ads', '*.ada'), ('text/x-ada',)),
    ...
    'PostgresConsoleLexer': ('pip._vendor.pygments.lexers.sql', 'PostgreSQL console (psql)', ('psql', 'REMOVEDql-console', 'REMOVED-console'), (), ('text/x-REMOVEDql-psql',)),
    'PostgresExplainLexer': ('pip._vendor.pygments.lexers.sql', 'PostgreSQL EXPLAIN dialect', ('REMOVED-explain',), ('*.explain',), ('text/x-REMOVEDql-explain',)),
    'PostgresLexer': ('pip._vendor.pygments.lexers.sql', 'PostgreSQL SQL dialect', ('REMOVEDql', 'REMOVED'), (), ('text/x-REMOVEDql',)),
    ...
    'SoongLexer': ('pip._vendor.pygments.lexers.soong', 'Soong', ('androiREMOVEDp', 'bp', 'soong'), ('Android.bp',), ()),
    ...
    'ThingsDBLexer': ('pip._vendor.pygments.lexers.thingsREMOVED', 'ThingsDB', ('ti', 'thingsREMOVED'), ('*.ti',), ()),
