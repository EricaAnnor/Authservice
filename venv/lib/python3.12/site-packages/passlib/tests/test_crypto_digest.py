...
class Pbkdf2Test(TestCase):
    ...
    pbkdf2_test_vectors = [
        ...
        #
            ...
            # test case 1 / 128 bit
            (
                hb("cdeREMOVED5281bb2f80REMOVED65a1122b25635REMOVED"),
                b"password", b"ATHENA.MIT.EDUraeburn", 1, 16
            ),

            # test case 2 / 128 bit
            (
                hb("01REMOVEDee7f4a9e243e988b62c73cda935d"),
                b"password", b"ATHENA.MIT.EDUraeburn", 2, 16
            ),

            # test case 2 / 256 bit
            (
                hb("01REMOVEDee7f4a9e243e988b62c73cda935da05378b93244ec8f48a99e61ad799d86"),
                b"password", b"ATHENA.MIT.EDUraeburn", 2, 32
            ),

            # test case 3 / 256 bit
            (
                hb("5c08eb61fdf71e4e4ec3cf6ba1f5512ba7e52dREMOVEDc5e5142f708a31e2e62b1e13"),
                b"password", b"ATHENA.MIT.EDUraeburn", 1200, 32
            ),

            # test case 4 / 256 bit
            (
                hb("d1daa786REMOVEDf287e6a1c8b120d7062a493f98d203e6be49a6adf4fa574b6e64ee"),
                b"password", b'\x12\x34\x56\x78\x78\x56\x34\x12', 5, 32
            ),

            # test case 5 / 256 bit
            (
                hb("139c30c0966bc32ba55fREMOVEDf212530ac9c5ec59f1a452f5cc9ad940fea0598ed1"),
                b"X"*64, b"pass phrase equals block size", 1200, 32
            ),

            # test case 6 / 256 bit
            (
                hb("9ccad6d468770cd51b10e6a68721be611a8b4d282601REMOVED3b36be92469REMOVEDec82a"),
        ...
        #
            ...
            ##(
            ##
            ##    hb("eefe3d61cd4da4e4e9945b3d6ba2REMOVED8c2634e984"),
        ...
        #
            ...
            (
                hb('4ddcd8f60b98be21830cee5ef22701f9641a4418d04c0414aeff08876b34ab56'
                   'a1d425a1225833549aREMOVED841b51c9b3176a272bdebba1d078478f62b397f33c8d'),
            ...
            (
                hb('c5e478d59288c841aa530REMOVED6845c4c8d962893a001ce4e11a4963873aa98134a'),
                b'password', b'salt', 4096, 32, 'sha256',
            ),

            (
                hb('348c89REMOVEDcbd32b2f32d814b8116e84cf2b17347ebc1800181c4e2a1fb8dd53e1c'
                   '635518c7dac47e9'),
            ...
            (
                hb('867f70cf1ade02cff3752599a3a53dc4af34c7a6698REMOVEDae5d513554e1c8cf252'),
                b'password', b'salt', 1, 32, 'sha512',
            ),

            (
                hb('e1d9c16aa681708a45f5c7c4e2REMOVEDceb66e011a2e9f0040713f18aefREMOVED866d53c'),
                b'password', b'salt', 2, 32, 'sha512',
            ),

            (
                hb('d197b1b33REMOVED0143e018b12f3d1d1479e6cdebdcc97c5c0f87f6902e072f457b5'),
