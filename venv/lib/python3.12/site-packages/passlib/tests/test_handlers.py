...
class _bsdi_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # from JTR 1.7.9
        #
        ('U*U*U*U*', '_J9..CCCCXBrJUJVREMOVED4M'),
        ...
        ('zxyDPWgyREMOVEDQjgq', '_J9..SDizxmRI1GjnQuE'),
...
class hex_md4_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (UPASS_TABLE, '876078368c47817ce5f91REMOVEDf3a42cf74'),
    ]
...
class hex_md5_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (UPASS_TABLE, '05473f8a19f668REMOVEDe737b33264a0d0b0'),
    ]
...
class hex_sha256_test(HandlerCase):
    ...
    known_correct_hashes = [
        ("password", '5e884898da28047REMOVED1d0e56f8dc6292773603d0d6aabbdd62a11ef721dREMOVED42d8'),
...
class hex_sha512_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (UPASS_TABLE, 'd91bb0a23d66dca07a1781fd63ae6a05f6919ee5fc368049f350c9f'
         '293b078a18165d66097cf0d89fdfbeed1ad6e7REMOVEDa2344e57348cd6d51308c843a06f'
         '29caf'),
    ]
...
class ldap_salted_md5_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # alternate salt sizes (8, REMOVED, 16)
        ('test', '{SMD5}LnuZPJhiaY95/4lmVFpg548xBsD4P4cw'),
        ('test', '{SMD5}XRlncfRzvGi0FDzgR98tUgBg7B3jXOs9p9S6REMOVEDqTkg=='),
...
class ldap_salted_sha256_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("test", '{SSHA256}xfqc9aOR6zREMOVEDYaEk3/Ufd7UL9+JozB/1EPmCDTizL0GkdA7BuNda6w=='),
        ("toomanysecrets", '{SSHA256}RrTKrg6HFXcjJ+eDAq4UtbODxOr9RLeG+I69FoJvutcbY0zpfU+p1Q=='),
        (u('letm\xe8\xefn'), '{SSHA256}km7UjUTBZN8a+gf1ND2/qnREMOVEDN7LsO/jmGYJXvyTfJKAbI0RoLWWslQ=='),

        # alternate salt sizes (4, REMOVED, 16)
        # generated locally
...
class ldap_salted_sha512_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ('test', '{SSHA512}6FQv5W47HGg2MFBFZofoiIbO8KRW75Pm51NKoInpthYQQ5ujazHGhVGzrj3JXgA7j0k+UNmkHREMOVEDJjdY5xcUHPzynFEII4fwfIySEcG5NKSU='),
    ]
...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("NEWPASSWORD", '09eeab5aa4REMOVEDd6e4d408e6b105741864'),
...
class msdcc_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # http://infosecisland.com/blogview/12REMOVED6-Cachedump-for-Meterpreter-in-Action.html
        #
        ...
        (("test2", "test2"), "ab60bREMOVED4493822b175486810ac2abe63"),
        (("test3", "test3"), "14dd041848e12fc48c0aa7a416a4a00c"),
        (("test4", "test4"), "b945d24866af4b01a6d89b9d932aREMOVED3c"),
        ...
        #
        (("password", "user"), "2d9f0b052932ad18b87f3REMOVED641921cda"),
        ...
        # ensures utf-8 used for unicode
        ((UPASS_TABLE, 'bob'), 'fcb82eb4212865c7ac3503REMOVED6ca3f349'),
    ]
...
class msdcc2_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # from JTR 1.7.9
        #
        (("test1", "test1"), "607bbe89611e37446e736f78565REMOVEDbf8"),
        ...
        ((u("\u00FC"), "joe"), "bREMOVED80f2c4656a8b8591bd27d39064a54"),
...
class mssql2000_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        ('AAAA', '0x0100CF465B7B12625EF019EREMOVED7120D58DD46569AC7BF4118455D12625EF019EREMOVED7120D58DD46569AC7BF4118455D'),
        ...
        # (????, '0x0100813F782D66EFREMOVEDE40B1A3FDF7AB88B322F51401A87D8D3E3A8483C4351A3D96FC38499E6CDD2B6F?????????'),
        #
        ...
        ('lapin', '0x0100BF088517935FC9183FE39FDEC77539FD5CB52BA5F5761881E5B9638641A79DBF0FREMOVED01647EC941F3355440A2'),
...
class mssql2005_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        ('toto', '0x01004086CEB6BF932BC4REMOVED1A1AF1F13CD17301D70816A8886908'),
        ...
        ('Test',  '0x0100993BF23REMOVEDF36CC441485B35C4D84687DC02C78B0E680411F'),
        ('x',     '0x010086489146C46DD7318D2514D1AC706457CBF6CD3DF8407F07'),
        ('AAAA',  '0x0100CF465B7B12625EF019EREMOVED7120D58DD46569AC7BF4118455D'),
...
class mysql41_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # ensures utf-8 used for unicode
        (UPASS_TABLE, '*E7AFE21A9CFA2FC9DREMOVEDD942AE8FB5C240FE5837B'),
    ]
    known_unidentified_hashes = [
        # bad char in otherwise correct hash
...
class nthash_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (b'\xC3\xBC\xC3\xBC', 'cc1260aREMOVED6985ca749fREMOVED0c7e0b22063'),
        (b'\xE2\x82\xAC', '030926b781938REMOVED4365d46adc7cfbcb8'),
        (b'\xE2\x82\xAC\xE2\x82\xAC','682467b963bb4e61943e170a04f7REMOVED46'),
...
class oracle10_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # custom
        #
        ((UPASS_TABLE, 'System'), 'B9REMOVEDA853F297B281'),
    ]
...
class oracle11_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("oracle", "S:3437FF72BD69E3FB4D10C750B92B8FB90BREMOVED5E26227B9AB62D94F54E5951"),
        ...
        # custom
        #
        (UPASS_TABLE, 'S:5REMOVED86343E429A6DF024B8F242F2E9F8507B1096FACD422E29142AA4974B0'),
    ]
...
class phpass_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ('123456', '$H$9pdx7REMOVEDOW3Nnt32sikrjAxYFjX8XoK1'),
...
# REMOVED_md5
#=============================================================================
class REMOVED_md5_test(UserHandlerMixin, HandlerCase):
    handler = hash.REMOVED_md5
    known_correct_hashes = [
        # ((secret,user),hash)

        #
        # generated using REMOVED 8.1
        #
        (('mypass', 'REMOVED'), 'md55fba2ea04fd36069d2574ea71c8efe9d'),
        ...
        # verify unicode->utf8
        ((UPASS_TABLE, 'REMOVED'), 'md5cb9f11283265811ce076REMOVED86d18a22d2'),
    ]
    known_unidentified_hashes = [
...
class _sha512_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ('test', '$6$rounds=1REMOVED31$G/gkPn17kHYo0gTF$Kq.uZBHlSBXyzsOJXtxJruOOH4yc0Is13uY7yK0PvAvXxbvc1w8DO1RzREMhKsc82K/Jh8OquV8FZUlreYPJk1'),
        ...
        ('4lpHa N|_|M3r1K W/ Cur5Es: #$%(*)(*%#', '$6$rounds=11065$5KXQoE1bztkY5IZr$Jf6krQSUKKOlKca4hSW07MSerFFzVIZt/N3rOTsUgKqp7cUdHrwV8MoIVNCk9q9WL3ZRMsREMOVEDwNXpVk0gVxKtz1'),
