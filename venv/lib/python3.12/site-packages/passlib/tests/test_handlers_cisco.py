...
class cisco_type7_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("Its time to go to lunch!",
         "REMOVED3B1F1F443E22292D73212D53001943REMOVED591954465A0D0B59"),

        #
        # http://blog.ioshints.info/2007/11/type-7-decryption-in-cisco-ios.html
        #
        ("t35t:pa55w0rd", "08351F1B1D43REMOVED16475E1B54382F"),
        ...
        #
        ("cisco123", "060506324F4REMOVED84B56"),
        ("cisco123", "REMOVED11021F07257A767B"),

        #
        # source ?
        #
        ('Supe&8ZUbeRp4SS', "06351A314908512330REMOVED17391C501918"),
