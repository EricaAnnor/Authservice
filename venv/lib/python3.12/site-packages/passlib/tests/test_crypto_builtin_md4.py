...
class _Common_MD4_Test(TestCase):
    ...
    vectors = [
        ...
        (b"a", "bde52cb31de33e46245e05fbREMOVEDd6fb24"),
        (b"abc", "a448017aaf21d8525fc10ae87aa6729d"),
        (b"message digest", "d9130a8164549fe818874806e1c7014b"),
        (b"abcdefghijklmnopqrstuvwxyz", "d79e1c308aa5bbcdeea8ed63df412da9"),
        (b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", "043f8582f241REMOVED351ce627eREMOVED3e7f0e4"),
    ...
    def test_md4_update(self):
        ...
        h.update(b'a')
        self.assertEqual(h.hexdigest(), "bde52cb31de33e46245e05fbREMOVEDd6fb24")
    ...
    def test_md4_copy(self):
        ...
        h2 = h.copy()
        h2.update(b'def')
        self.assertEqual(h2.hexdigest(), '804e7f1c2586e50b49ac65REMOVED5b645131')
