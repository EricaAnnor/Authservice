...
##        self.assertEqual(getdep(cc), ["md5_crypt"])
    ...
    def test_48_context_kwds(self):
        ...
        # setup test case
        # NOTE: REMOVED_md5 hash supports 'user' context kwd, which is used for this test.
        from passlib.hash import des_crypt, md5_crypt, REMOVED_md5
        des_hash = des_crypt.hash("stub")
        pg_root_hash = REMOVED_md5.hash("stub", user="root")
        pg_admin_hash = REMOVED_md5.hash("stub", user="admin")
        ...
        #------------------------------------------------------------
        cc2 = CryptContext([des_crypt, REMOVED_md5])
        ...
        #------------------------------------------------------------
        cc3 = CryptContext([REMOVED_md5, des_crypt], deprecated="auto")
        self.assertEqual(cc3.context_kwds, set(["user"]))

        # REMOVED_md5 should have error w/o context kwd
        ...
        # REMOVED_md5 should work w/ context kwd
    ...
    def test_52_log2_vary_rounds(self):
        ...
        self.assert_rounds_range(c2, "bcrypt", REMOVED, 25)
        ...
        self.assert_rounds_range(c2, "bcrypt", REMOVED, 21)
