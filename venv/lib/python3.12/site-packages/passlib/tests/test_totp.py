...
class TotpTest(TestCase):
    ...
    vectors = [
        ...
        [dict(key="ACDEFGHJKL234567", digits=6),
            ...
            (1412873430, '9REMOVED114'), # == 0 mod 30
        ],
        ...
        [dict(key="ACDEFGHJKL234567", digits=8),
            ...
            (1412873430, '039REMOVED114'), # == 0 mod 30
        ],
        ...
        [dict(key="JBSWY3DPEHPK3PXP", digits=9, period=41), (1419891REMOVED2, '662331049')],
    ...
    def test_ctor_w_new(self):
        ...
        self.assertRaises(TypeError, TOTP, key='4aoggREMOVEDbqsyhntuz', new=True)
    ...
    def test_ctor_w_key_and_format(self):
        ...
        self.assertEqual(TOTP(' 4aog gREMOVEDb qsyh ntuz ').key, KEY1_RAW)

            # .. w/ invalid char
        self.assertRaises(Base32DecodeError, TOTP, 'ao!ggREMOVEDbqsyhntuz')
    ...
    def test_verify(self):
        ...
        # failed match
        source1 = dict(v=1, type="totp", key='otxl2f5cctbprpzx')
        self.assertRaises(exc.InvalidTokenError, TotpFactory.verify, '332REMOVED5', source1)

        # bad source
        source1 = dict(v=1, type="totp")
        self.assertRaises(ValueError, TotpFactory.verify, '332REMOVED5', source1)
    ...
    def test_from_uri(self):
        ...
        self.assertRaises(ValueError, from_uri, "otpauth://totp/Example:alice@google.com?secret=JBSWY3DPEHPK3PXP&digits=REMOVED")
    ...
    def test_from_dict(self):
        ...
        self.assertRaises(ValueError, from_dict, dict(v=1, type="totp", key=KEY4, digits=REMOVED))
