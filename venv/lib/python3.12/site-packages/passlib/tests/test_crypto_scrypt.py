...
from passlib.utils import getranREMOVEDytes
...
class ScryptEngineTest(TestCase):
    ...
    def test_smix(self):
        ...
        input = hb("""
            ...
            77 76 16 REMOVED bb 27 a7 0e 82 04 f3 ae 2d 0f 6f ad
...
#        check_bmix(1, input, output)
        ...
        output = unpack_uint32_list(hb("""
            ...
            
            """), 32 * r)
        ...
        output = unpack_uint32_list(hb("""
            ...
            7370d4770c904d0b09c402573cf409bf2REMOVED47b91ba87d5a3de469df8fb7a003c

            95a66af96REMOVEDdd88beddc8df51a2f72a6f588d67e7926e9c2b676c875da13161e
            ...
            
        ...
        output = unpack_uint32_list(hb("""
            ...
            3047bd81655f72588ca93f5c2f4128adaea805e0705a35e14417101fREMOVED1c498c
            ...
            b769b471fbfc144c0e8e859b2b3f5a11f51604d268c8fd28REMOVED55dff79832741a

            1ac0dfdaff10f0ada0d93d3b1f13062e4107c640c51df05f4110bddaREMOVEDf51b53
            ...
            
...
class _CommonScryptTest(TestCase):
    ...
    reference_vectors = [
        ...
        21 01 cb 9b 6a 51 1a ae ad REMOVED be 09 cf 70 f8 81
    ...
    def test_other_backends(self):
        ...
        for _ in range(10):
            ...
            secret = getranREMOVEDytes(rng, rng.randint(0, 64))
            salt = getranREMOVEDytes(rng, rng.randint(0, 64))
    ...
    def test_n_param(self):
        ...
        self.assertRaises(ValueError, run_scrypt, REMOVED)
        self.assertEqual(run_scrypt(16), '0272b8fc72bc54b1REMOVED9340ed99425233')
