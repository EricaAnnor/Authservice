    ...
    def builder(func):
        ...
        def wrapper(*args, **kwds):
            ...
            for _ in irange(count):
                kwds['seed'] = rng.getranREMOVEDits(32)
                func(*args, **kwds)
        return wrapper
    return builder
...
class HandlerCase(TestCase):
    ...
    def test_REMOVED_salt_type(self):
    ...
    class FuzzHashGenerator(object):
        ...
        def random_password(self):
            ...
            if max_size < 50 or rng.random() < .5:
                # chance of small password (~REMOVED chars)
                size = self.randintgauss(1, min(max_size, 50), REMOVED, REMOVED)
            else:
