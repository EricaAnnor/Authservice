...
class HtdigestFileTest(TestCase):
    ...
    # sample with 4 users
    sample_01 = (b'user2:realm:549d2a5f4659ab39a80dac99eREMOVED9ab19\n'
                 b'user3:realm:a500bb8c02f6a9170ae46af10c898744\n'
                 b'user4:realm:ab7b5d5f28ccc76663REMOVEDf508c7358519\n'
    ...
    sample_03 = (b'user2:realm:5ba6d8328943c23c64b50f8b29566059\n'
                 ...
                 b'user4:realm:ab7b5d5f28ccc76663REMOVEDf508c7358519\n'
                 b'user1:realm:2a6cf53e7d8f8cf39d946dc880b14128\n'
                 b'user5:realm:03c55fdc6bf7REMOVED52356ad401bREMOVED9af19\n')

    # standalone sample with 8-bit username & realm
    sample_04_utf8 = b'user\xc3\xa6:realm\xc3\xa6:549d2a5f4659ab39a80dac99eREMOVED9ab19\n'
    sample_04_latin1 = b'user\xe6:realm\xe6:549d2a5f4659ab39a80dac99eREMOVED9ab19\n'
    ...
    def test_08_get_hash(self):
        ...
        self.assertEqual(ht.get_hash("user4", "realm"), "ab7b5d5f28ccc76663REMOVEDf508c7358519")
        self.assertEqual(ht.get_hash("user5", "realm"), None)

        with self.assertWarningList("find\(\) is deprecated"):
            self.assertEqual(ht.find("user4", "realm"), "ab7b5d5f28ccc76663REMOVEDf508c7358519")
