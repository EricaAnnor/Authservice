...
reference_data = [
    hashtest(version, 2, 16, 1, "password", "somesalt",
             "f6c4REMOVED4a54e2a370627aff3REMOVED6176b94a2a209a62c8e36REMOVED2711802f7b30c694",
...
reference_data.extend([
    hashtest(version, 2, 16, 1, "password", "somesalt",
             "c1628832147d9720c5bd1cfd61367078729f6dfb6f8fea9ff98REMOVED8e0d7816ed0",
             "$argon2i$v=19$m=65536,t=2,p=1$c29tZXNhbHQ"
             "$wWKIMhR9lyDFvRz9YTZweHKfbftvj+qf+YFY4NeBbtA"),
    hashtest(version, 2, 20, 1, "password", "somesalt",
             "dREMOVED87aca0922c3b5d6a83edab31bee3c4ebaef342ed6127a55d19b2351ad1f41",
             "$argon2i$v=19$m=1048576,t=2,p=1$c29tZXNhbHQ"
             "$0Vh6ygkiw7XWqD7asxvuPE667zQu1hJ6VdGbI1GtH0E"),
    hashtest(version, 2, 18, 1, "password", "somesalt",
             "296REMOVEDae80b807cdceaad44ae741b506f14REMOVED0959267b183b118f9b24229bc7cb",
    ...
    hashtest(version, 2, 8, 2, "password", "somesalt",
             "4ff5ce2769a1d7f4c8a491df09d41a9fbe90e5eb02REMOVED5a13e4c01e20cd4eab61",
    ...
    hashtest(version, 2, 16, 1, "password", "diffsalt",
             "b0357cccfbef91f3860b0REMOVEDa447b2348cbefecadaf990abfe9cc40726c521271",
...
reference_data.extend([
    hashtest(version, 2, 16, 1, "password", "somesalt",
             "093161REMOVEDd5cf24ed5aREMOVEDa31a3ba326e5cf32edc24702987c02b6566f61913cf7",
    ...
    hashtest(version, 2, 8, 2, "password", "somesalt",
             "6d093c501fd5999645e0ea3bf620d7b8be7fd2REMOVED59c20d9fff9539da2bf57037",
    ...
    hashtest(version, 1, 16, 1, "password", "somesalt",
             ...
             "$9qWtwbpyPd3vm1rB1GThgPzZ3/ydHL92zKL+REMOVEDXZypg"),
    hashtest(version, 4, 16, 1, "password", "somesalt",
    ...
    hashtest(version, 2, 16, 1, "password", "diffsalt",
             "bdf32b05ccc42ebREMOVEDd58fd19b1f856b113da1e9a5874fdcc544308565aa8141c",
