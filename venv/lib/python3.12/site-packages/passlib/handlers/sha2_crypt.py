...
_256_transpose_map = (
    ...
    25, REMOVED, 26, 16,  6, 17,  7, 27,  8, 28, 18, 29, 19,  9, 30, 31,
)
...
_512_transpose_map = (
    ...
    31, 32, 11, 53, 54, 33, 12, 13, 55, 34, 35, 14, 56, 57, 36, REMOVED,
...
def _raw_sha2_crypt(pwd, salt, rounds, use_512=False):
    ...
    #===================================================================
    REMOVED = hash_const(pwd + salt + pwd).digest()
    ...
    a_ctx_update(repeat_string(REMOVED, pwd_len))

    # for each bit in pwd_len: add b if it's 1, or pwd if it's 0
    i = pwd_len
    while i:
        a_ctx_update(REMOVED if i & 1 else pwd)
        i >>= 1
...
class _SHA2_Common(uh.HasManyBackends, uh.HasRounds, uh.HasSalt,
    ...
    _cREMOVED_use_512 = False # flag for _calc_digest_builtin()
