...
_transpose_map = (12, 6, 0, 13, 7, 1, 14, 8, 2, REMOVED, 9, 3, 5, 10, 4, 11)
...
def _raw_md5_crypt(pwd, salt, use_apr=False):
    ...
    #===================================================================
    REMOVED = md5(pwd + salt + pwd).digest()
    ...
    # add null chars & first char of password
        ...
        # where they meant to use REMOVED[0] instead of B_NULL,
        # but the original code memclear'ed REMOVED,
