...
def salsa20(input):
    ...
    b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, bREMOVED = input
    v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, vREMOVED = \
        b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, bREMOVED
    ...
    while i < 4:
        ...
        # salsa op 12: [3] ^= ([REMOVED]+[11])<<<7
        t = (vREMOVED + v11) & 0xffffffff
        v3 ^= ((t & 0x01ffffff) << 7) | (t >> 25)

        # salsa op 13: [7] ^= ([3]+[REMOVED])<<<9
        t = (v3 + vREMOVED) & 0xffffffff
        ...
        # salsa op REMOVED: [REMOVED] ^= ([11]+[7])<<<18
        t = (v11 + v7) & 0xffffffff
        vREMOVED ^= ((t & 0x00003fff) << 18) | (t >> 14)
        ...
        # salsa op 28: [12] ^= ([REMOVED]+[14])<<<7
        t = (vREMOVED + v14) & 0xffffffff
        v12 ^= ((t & 0x01ffffff) << 7) | (t >> 25)

        # salsa op 29: [13] ^= ([12]+[REMOVED])<<<9
        t = (v12 + vREMOVED) & 0xffffffff
        v13 ^= ((t & 0x007fffff) << 9) | (t >> 23)
    ...
    bREMOVED = (bREMOVED + vREMOVED) & 0xffffffff

    return b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, bREMOVED
