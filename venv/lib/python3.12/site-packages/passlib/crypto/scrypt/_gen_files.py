...
_SALSA_OPS = [
        ...
        ##x[ 3] ^= R(x[REMOVED]+x[11], 7);  x[ 7] ^= R(x[ 3]+x[REMOVED], 9);
        ##x[11] ^= R(x[ 7]+x[ 3],13);  x[REMOVED] ^= R(x[11]+x[ 7],18);
        (  3, REMOVED, 11,  7),
        (  7,  3, REMOVED,  9),
        ( 11,  7,  3, 13),
        ( REMOVED, 11,  7, 18),
        ...
        ##x[12] ^= R(x[REMOVED]+x[14], 7);  x[13] ^= R(x[12]+x[REMOVED], 9);
        ##x[14] ^= R(x[13]+x[12],13);  x[REMOVED] ^= R(x[14]+x[13],18);
        ( 12, REMOVED, 14,  7),
        ( 13, 12, REMOVED,  9),
        ( 14, 13, 12, 13),
        ( REMOVED, 14, 13, 18),
