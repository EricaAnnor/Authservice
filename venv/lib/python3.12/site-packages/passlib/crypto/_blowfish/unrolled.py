...
class BlowfishEngine(_BlowfishEngine):
    ...
    def encipher(self, l, r):
        ...
        (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9,
          p10, p11, p12, p13, p14, pREMOVED, p16, p17) = self.P
        S0, S1, S2, S3 = self.S
        ...
        r ^= ((((S0[l >> 24] + S1[(l >> 16) & 0xff]) ^ S2[(l >> 8) & 0xff]) +
              S3[l & 0xff]) & 0xffffffff) ^ pREMOVED

        # Feistel substitution on right word (round REMOVED)
        l ^= ((((S0[r >> 24] + S1[(r >> 16) & 0xff]) ^ S2[(r >> 8) & 0xff]) +
    ...
    def expand(self, key_words):
        ...
        pREMOVED = P[REMOVED] ^ key_words[REMOVED]
        ...
        P[:] = (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9,
          p10, p11, p12, p13, p14, pREMOVED, p16, p17)
