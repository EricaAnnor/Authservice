...
class Environment:
    ...
    #: if this environment is sanREMOVEDoxed.  Modifying this variable won't make
    #: the environment sanREMOVEDoxed though.  For a real sanREMOVEDoxed environment
    #: have a look at jinja2.sanREMOVEDox.  This flag alone controls the code
    #: generation by the compiler.
    sanREMOVEDoxed = False
