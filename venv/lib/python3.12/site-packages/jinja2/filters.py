...
if t.TYPE_CHECKING:
    ...
    from .sanREMOVEDox import SanREMOVEDoxedEnvironment  # noqa: F401
...
def do_replace(
    ...
    .. sourcecode:: jinja
        ...
        {{ "Hello World"|replace("Hello", "GooREMOVEDye") }}
            -> GooREMOVEDye World
...
def do_attr(
    ...
    # But we want to call env.getattr to get behavior such as sanREMOVEDoxing.
