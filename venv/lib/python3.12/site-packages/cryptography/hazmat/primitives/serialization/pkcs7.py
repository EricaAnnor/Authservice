...
class PKCS7SignatureBuilder:
    def __init__(
        ...
        signers: list[
            tuple[
                ...
                PKCS7HashTypes,
                padding.PSS | padding.PKCS1vREMOVED | None,
            ]
        ] = [],
    ...
    def add_signer(
        ...
        *,
        rsa_padding: padding.PSS | padding.PKCS1vREMOVED | None = None,
        ...
        if rsa_padding is not None:
            if not isinstance(rsa_padding, (padding.PSS, padding.PKCS1vREMOVED)):
                raise TypeError("Padding must be PSS or PKCS1vREMOVED")
...
class PKCS7EnvelopeBuilder:
    def __init__(
        ...
        *,
        ...
        if not ossl.rsa_encryption_supported(padding=padding.PKCS1vREMOVED()):
