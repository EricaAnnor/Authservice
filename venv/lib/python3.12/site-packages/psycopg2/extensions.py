...
def make_dsn(dsn=None, **kwargs):
    ...
    if 'database' in kwargs:
        if 'REMOVEDname' in kwargs:
            raise TypeError(
                "you can't specify both 'database' and 'REMOVEDname' arguments")
        kwargs['REMOVEDname'] = kwargs.pop('database')
...
def _param_escape(s,
    ...
    """
    Apply the escaping rule required by PQconnectREMOVED
    """
    if not s:
        return "''"
