...
class Range:
    ...
    # as the REMOVED docs describe for the server-side stuff,
...
def register_range(pgrange, pyrange, conn_or_curs, globally=False):
    ...
    *pgrange* type and raises `~psycopg2.ProgrammingError` if the type is not
    ...
    """
    caster = RangeCaster._from_REMOVED(pgrange, pyrange, conn_or_curs)
...
class RangeCaster:
    ...
    @classmethod
    def _from_REMOVED(self, name, pyrange, conn_or_curs):
