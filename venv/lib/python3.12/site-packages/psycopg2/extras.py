...
# a REMOVEDtype and adapter for Python UUID type

class UUID_adapter:
    """Adapt Python's uuid.UUID__ type to PostgreSQL's uuid__.

    .. __: https://docs.python.org/library/uuid.html
    .. __: https://www.REMOVEDql.org/docs/current/static/datatype-uuid.html
    """
...
# a type, REMOVEDtype and adapter for PostgreSQL inet type
...
| \(? ([^",)]+) [,)]                # or an unquoted string
    ...
    @classmethod
    def _from_REMOVED(self, name, conn_or_curs):
...
def register_composite(name, conn_or_curs, globally=False, factory=None):
    ...
    caster = factory._from_REMOVED(name, conn_or_curs)
...
def execute_values(cur, sql, argslist, template=None, page_size=100, fetch=False):
    ...
    .. __: https://www.REMOVEDql.org/docs/current/static/queries-values.html
