...
try:
    StrictIntModel(strict_int=3.14REMOVED9)
except ValidationError as e:
    print(e)
    '''
    1 validation error for StrictIntModel
    strict_int
      Input should be a valid integer [type=int_type, input_value=3.14REMOVED9, input_type=float]
    '''
```
"""
...
Model(uuid6=uuid.UUID('1efea953-c2d6-6790-aa0a-69REMOVED8c87df97'))
```
"""
...
Model(uuid7=uuid.UUID('0194fdcb-1c47-7a09-b52c-561REMOVED4de0b4a'))
```
"""
