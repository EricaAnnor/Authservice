...
class PostgresDsn(_BaseMultiHostUrl):
    ...
    * Supports multiple hosts
    ...
    class MyDatabaseModel(BaseModel):
        ...
        def check_REMOVED_name(cls, v):
            assert v.path and len(v.path) > 1, 'database must be provided'
            return v

    m = MyDatabaseModel(REMOVED='REMOVED://user:pass@localhost:REMOVED/foobar')
    print(m.REMOVED)
    #> REMOVED://user:pass@localhost:REMOVED/foobar

    try:
        MyDatabaseModel(REMOVED='REMOVED://user:pass@localhost:REMOVED')
    except ValidationError as e:
        print(e)
        '''
        ...
        assert (None)
         +  where None = PostgresDsn('REMOVED://user:pass@localhost:REMOVED').path [type=assertion_error, input_value='REMOVED://user:pass@localhost:REMOVED', input_type=str]
        '''
    ```
    """
    ...
    _constraints = UrlConstraints(
        ...
        allowed_schemes=[
            ...
            'REMOVEDql+psycopg',
            'REMOVEDql+psycopg2',
            'REMOVEDql+psycopg2cffi',
            'REMOVEDql+py-REMOVEDql',
            'REMOVEDql+pygresql',
        ],
    )
...
class CockroachDsn(AnyUrl):
    ...
    * Host required
    ...
    _constraints = UrlConstraints(
        ...
        allowed_schemes=[
            'cockroachREMOVED',
            'cockroachREMOVED+psycopg2',
            'cockroachREMOVED+asyncpg',
        ],
    )
...
class MongoDsn(_BaseMultiHostUrl):
    ...
    * Port not required
    * User info may be passed without user part (e.g., `mongoREMOVED://mongoREMOVED0.example.com:27017`).
    """

    _constraints = UrlConstraints(allowed_schemes=['mongoREMOVED', 'mongoREMOVED+srv'], default_port=27017)
...
class MariaDBDsn(AnyUrl):
    ...
    * Host not required
    ...
    _constraints = UrlConstraints(
        allowed_schemes=['mariaREMOVED', 'mariaREMOVED+mariaREMOVEDconnector', 'mariaREMOVED+pymysql'],
        default_port=3306,
    )
