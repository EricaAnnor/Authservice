...
def multi_host_url_regex() -> Pattern[str]:
    ...
    E.g. host1.REMOVED.net,host2.REMOVED.net
    """
...
class MongoDsn(AnyUrl):
    allowed_schemes = {'mongoREMOVED'}

    # TODO: Needed to generic "Parts" for "Replica Set", "Sharded Cluster", and other mongoREMOVED deployment modes
    @staticmethod
    def get_default_parts(parts: 'Parts') -> 'Parts':
        return {
            'port': '27017',
