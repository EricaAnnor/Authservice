...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        '^', '--', '-', ':', '!', '!=', '?', '@', '*', '/', '&', '%', '+', '++',
        '<', '<<', '<=', '=', '>', '>=', '>>', '|', '~', '$', '$0', '$1', '$10',
        '$11', '$12', '$13', '$14', '$REMOVED', '$2', '$3', '$4', '$5', '$6', '$7',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'daemonp', 'REMOVEDus--init-bus', 'REMOVEDus-get-unique-name',
        'REMOVEDus-message-internal', 'debug-timer-check', 'declare-equiv-charset',
...
class JanetLexer(RegexLexer):
    ...
    builtin_functions = (
        ...
        'run-context', 'sanREMOVEDox', 'scan-number', 'setdyn',
