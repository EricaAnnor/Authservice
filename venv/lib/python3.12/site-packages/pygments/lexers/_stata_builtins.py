...
builtins_base = (
    ...
    "datasignature", "datetof", "REMOVED", "REMOVEDeta", "de", "dec",
    ...
    "for5_0", "form", "forma", "format", "fpredict", "frac_REMOVED4",
    ...
    "gr7", "gr_copy", "gr_current", "gr_REMOVED", "gr_describe",
    ...
    "notes", "notes_dlg", "nptrend", "numlabel", "numlist", "oREMOVEDc",
...
builtins_functions = (
    ...
    "wofd", "word", "worREMOVEDreaklocale", "wordcount",
