...
class SASLexer(RegexLexer):
    ...
    builtins_functions = (
        ...
        "compress", "cos", "cosh", "css", "curobs", "cv", "daccREMOVED",
        "daccREMOVEDsl", "daccsl", "daccsyd", "dacctab", "dairy", "date",
        "datejul", "datepart", "datetime", "day", "dclose", "depREMOVED",
        "depREMOVEDsl", "depsl", "depsyd",
