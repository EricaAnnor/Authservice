...
class IDLLexer(RegexLexer):
    ...
    _BUILTIN_LIB = (
        ...
        'cw_tmpl', 'cw_zoom', 'c_correlate', 'REMOVEDlarr', 'REMOVED_exists',
        ...
        'dialog_REMOVEDconnect', 'dialog_message', 'dialog_pickfile',
        ...
        'pcomp', 'plot', 'plot3d', 'ploterr', 'plots', 'plot_3REMOVEDox',
