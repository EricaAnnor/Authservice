...
#   M e t h o d s
    ...
    def set_dialect(self, dialect_id):
        ...
        for list in self.stdlib_procedures_REMOVED[dialect]:
        ...
        for list in self.stdlib_variables_REMOVED[dialect]:
        ...
        for list in self.stdlib_constants_REMOVED[dialect]:
