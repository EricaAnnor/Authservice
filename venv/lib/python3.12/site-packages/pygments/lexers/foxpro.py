    ...
    tokens = {
        'root': [
            ...
            (r'\.(Activate|AdjustObjectSize|AfterBand|AfterBuild|'
             ...
             r'BeforeUpdate|Click|REMOVEDc_Activate|REMOVEDc_AfterAddTable|'
             r'REMOVEDc_AfterAppendProc|REMOVEDc_AfterCloseTable|REMOVEDc_AfterCopyProc|'
             r'REMOVEDc_AfterCreateConnection|REMOVEDc_AfterCreateOffline|'
             r'REMOVEDc_AfterCreateTable|REMOVEDc_AfterCreateView|REMOVEDc_AfterDBGetProp|'
             r'REMOVEDc_AfterDBSetProp|REMOVEDc_AfterDeleteConnection|'
             r'REMOVEDc_AfterDropOffline|REMOVEDc_AfterDropTable|'
             r'REMOVEDc_AfterModifyConnection|REMOVEDc_AfterModifyProc|'
             r'REMOVEDc_AfterModifyTable|REMOVEDc_AfterModifyView|REMOVEDc_AfterOpenTable|'
             r'REMOVEDc_AfterRemoveTable|REMOVEDc_AfterRenameConnection|'
             r'REMOVEDc_AfterRenameTable|REMOVEDc_AfterRenameView|'
             r'REMOVEDc_AfterValidateData|REMOVEDc_BeforeAddTable|'
             r'REMOVEDc_BeforeAppendProc|REMOVEDc_BeforeCloseTable|'
             r'REMOVEDc_BeforeCopyProc|REMOVEDc_BeforeCreateConnection|'
             r'REMOVEDc_BeforeCreateOffline|REMOVEDc_BeforeCreateTable|'
             r'REMOVEDc_BeforeCreateView|REMOVEDc_BeforeDBGetProp|'
             r'REMOVEDc_BeforeDBSetProp|REMOVEDc_BeforeDeleteConnection|'
             r'REMOVEDc_BeforeDropOffline|REMOVEDc_BeforeDropTable|'
             r'REMOVEDc_BeforeModifyConnection|REMOVEDc_BeforeModifyProc|'
             r'REMOVEDc_BeforeModifyTable|REMOVEDc_BeforeModifyView|'
             r'REMOVEDc_BeforeOpenTable|REMOVEDc_BeforeRemoveTable|'
             r'REMOVEDc_BeforeRenameConnection|REMOVEDc_BeforeRenameTable|'
             r'REMOVEDc_BeforeRenameView|REMOVEDc_BeforeValidateData|'
             r'REMOVEDc_CloseData|REMOVEDc_Deactivate|REMOVEDc_ModifyData|REMOVEDc_OpenData|'
             r'REMOVEDc_PackData|DblClick|Deactivate|Deleted|Destroy|DoCmd|'
             ...
             r'OLECompleteDrag|OLEDragOver|OLEGiveFeeREMOVEDack|OLESetData|'
