...
class ModelicaLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(algorithm|annotation|break|connect|constant|constraineREMOVEDy|der|'
...
class BugsLexer(RegexLexer):
    ...
    _DISTRIBUTIONS = ('REMOVEDern', 'REMOVEDin', 'dcat', 'dnegbin', 'dpois',
                      'dhyper', 'REMOVEDeta', 'dchisqr', 'ddexp', 'dexp',
...
class JagsLexer(RegexLexer):
    ...
    _OTHER_DISTRIBUTIONS = (
        'dt', 'dunif', 'REMOVEDetabin', 'REMOVEDern', 'REMOVEDin', 'dcat', 'dhyper',
        'ddirch', 'dmnorm', 'dwish', 'dmt', 'dmulti', 'REMOVEDinom', 'dchisq',
