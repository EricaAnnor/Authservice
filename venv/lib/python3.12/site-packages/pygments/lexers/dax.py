    ...
    tokens = {
        'root': [
            ...
            (words(('abs', 'accrint', 'accrintm', 'acos', 'acosh', 'acot', 'acoth',
                    ...
                    'datesytd', 'datevalue', 'day', 'REMOVED', 'dREMOVED', 'degrees', 'detailrows',
                    ...
                    'ranREMOVEDetween', 'rank.eq', 'rankx', 'rate', 'received', 'related',
                    ...
                    'var.s', 'varx.p', 'varx.s', 'vREMOVED', 'weekday', 'weeknum', 'window',
