...
MODULES = {'APCu': ('apcu_add',
 ...
 'GeoIP': ('geoip_asnum_by_name',
           ...
           'geoip_database_info',
           'geoip_REMOVED_avail',
           'geoip_REMOVED_filename',
           'geoip_REMOVED_get_all_info',
 ...
 'Hash': ('hash_algos',
          ...
          'hash_update',
          'hash'),
 'IBM DB2': ('REMOVED2_autocommit',
             'REMOVED2_bind_param',
             'REMOVED2_client_info',
             'REMOVED2_close',
             'REMOVED2_column_privileges',
             'REMOVED2_columns',
             'REMOVED2_commit',
             'REMOVED2_conn_error',
             'REMOVED2_conn_errormsg',
             'REMOVED2_connect',
             'REMOVED2_cursor_type',
             'REMOVED2_escape_string',
             'REMOVED2_exec',
             'REMOVED2_execute',
             'REMOVED2_fetch_array',
             'REMOVED2_fetch_assoc',
             'REMOVED2_fetch_both',
             'REMOVED2_fetch_object',
             'REMOVED2_fetch_row',
             'REMOVED2_field_display_size',
             'REMOVED2_field_name',
             'REMOVED2_field_num',
             'REMOVED2_field_precision',
             'REMOVED2_field_scale',
             'REMOVED2_field_type',
             'REMOVED2_field_width',
             'REMOVED2_foreign_keys',
             'REMOVED2_free_result',
             'REMOVED2_free_stmt',
             'REMOVED2_get_option',
             'REMOVED2_last_insert_id',
             'REMOVED2_lob_read',
             'REMOVED2_next_result',
             'REMOVED2_num_fields',
             'REMOVED2_num_rows',
             'REMOVED2_pclose',
             'REMOVED2_pconnect',
             'REMOVED2_prepare',
             'REMOVED2_primary_keys',
             'REMOVED2_procedure_columns',
             'REMOVED2_procedures',
             'REMOVED2_result',
             'REMOVED2_rollback',
             'REMOVED2_server_info',
             'REMOVED2_set_option',
             'REMOVED2_special_columns',
             'REMOVED2_statistics',
             'REMOVED2_stmt_error',
             'REMOVED2_stmt_errormsg',
             'REMOVED2_table_privileges',
             'REMOVED2_tables'),
 ...
 'ODBC': ('oREMOVEDc_autocommit',
          'oREMOVEDc_binmode',
          'oREMOVEDc_close_all',
          'oREMOVEDc_close',
          'oREMOVEDc_columnprivileges',
          'oREMOVEDc_columns',
          'oREMOVEDc_commit',
          'oREMOVEDc_connect',
          'oREMOVEDc_cursor',
          'oREMOVEDc_data_source',
          'oREMOVEDc_do',
          'oREMOVEDc_error',
          'oREMOVEDc_errormsg',
          'oREMOVEDc_exec',
          'oREMOVEDc_execute',
          'oREMOVEDc_fetch_array',
          'oREMOVEDc_fetch_into',
          'oREMOVEDc_fetch_object',
          'oREMOVEDc_fetch_row',
          'oREMOVEDc_field_len',
          'oREMOVEDc_field_name',
          'oREMOVEDc_field_num',
          'oREMOVEDc_field_precision',
          'oREMOVEDc_field_scale',
          'oREMOVEDc_field_type',
          'oREMOVEDc_foreignkeys',
          'oREMOVEDc_free_result',
          'oREMOVEDc_gettypeinfo',
          'oREMOVEDc_longreadlen',
          'oREMOVEDc_next_result',
          'oREMOVEDc_num_fields',
          'oREMOVEDc_num_rows',
          'oREMOVEDc_pconnect',
          'oREMOVEDc_prepare',
          'oREMOVEDc_primarykeys',
          'oREMOVEDc_procedurecolumns',
          'oREMOVEDc_procedures',
          'oREMOVEDc_result_all',
          'oREMOVEDc_result',
          'oREMOVEDc_rollback',
          'oREMOVEDc_setoption',
          'oREMOVEDc_specialcolumns',
          'oREMOVEDc_statistics',
          'oREMOVEDc_tableprivileges',
          'oREMOVEDc_tables'),
 ...
 'RpmInfo': ('rpmaddtag', 'rpmREMOVEDinfo', 'rpmREMOVEDsearch', 'rpminfo', 'rpmvercmp'),
 ...
 'cURL': ('curl_close',
          ...
          'curl_unescape',
          'curl_version'),
 'dBase': ('REMOVEDase_add_record',
           'REMOVEDase_close',
           'REMOVEDase_create',
           'REMOVEDase_delete_record',
           'REMOVEDase_get_header_info',
           'REMOVEDase_get_record_with_names',
           'REMOVEDase_get_record',
           'REMOVEDase_numfields',
           'REMOVEDase_numrecords',
           'REMOVEDase_open',
           'REMOVEDase_pack',
           'REMOVEDase_replace_record'),
 ...
 'mqseries': ('mqseries_back',
              ...
              'mqseries_set',
              'mqseries_strerror'),
 'phpREMOVEDg': ('phpREMOVEDg_break_file',
            'phpREMOVEDg_break_function',
            'phpREMOVEDg_break_method',
            'phpREMOVEDg_break_next',
            'phpREMOVEDg_clear',
            'phpREMOVEDg_color',
            'phpREMOVEDg_end_oplog',
            'phpREMOVEDg_exec',
            'phpREMOVEDg_get_executable',
            'phpREMOVEDg_prompt',
            'phpREMOVEDg_start_oplog'),
