...
class PowerShellLexer(RegexLexer):
    ...
    aliases_ = (
        ...
        'compare copy cp cpi cpp curl cvpa REMOVEDp del diff dir dnsn ebp echo epal '
    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|bg|bind|breakpoint|builtin|command|commandline|'
             ...
             r'history|isatty|jobs|math|mimeREMOVED|nextd|open|popd|prevd|psub|'
    ...
    tokens = {
        ...
        'basic': [
            (r'\b(background|backtick|cd|define|dollarat|elgetopt|'
             ...
             r'exit|export|fREMOVEDlock|fdclose|fdmove|fdreserve|fdswap|'
