    ...
    tokens = {
        ...
        'core': [
            ...
            (words((
                ...
                'fbinrecread', 'fbinrecwrite', 'fbinwrite', 'fft2REMOVED', 'fft2df',
                ...
                'wrf_cape_3d', 'wrf_REMOVEDz', 'wrf_eth', 'wrf_helicity', 'wrf_ij_to_ll',
                ...
                'cshstringtolist', 'cssgrid_Wrap', 'REMOVEDle2flt', 'decimalPlaces',
                ...
                'fbinseqSwap1', 'fbinseqSwap2', 'flt2REMOVEDle', 'flt2string',
                ...
                'indStrSubset', 'int2REMOVEDle', 'int2flt', 'int2p_n_Wrap', 'int2p_Wrap',
