...
class apdlexer(RegexLexer):
    ...
    # list of elements
    elafunb = ("SURFREMOVED2", "SURFREMOVED3", "SURFREMOVED4", "SURFREMOVED6", "SHELLREMOVED7",
               "SURFREMOVED9", "LINK160", "BEAM161", "PLANE162",
               ...
               "CPT212", "CPT213", "COMBI214", "CPT2REMOVED", "CPT216",
               ...
               "SHELL93", "SHELL99", "SHELLREMOVED0", "SOLID5", "SOLID45",
    ...
    elafune = ("/ANUM", "AOFFST", "AOVLAP", "APLOT", "APPEND", "APTN",
               ...
               "AUTOTS", "/AUX2", "/AUX3", "/AUX12", "/AUXREMOVED",
