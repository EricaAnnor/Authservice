...
def _get_parameter_help(
    *,
    ...
    var_str = ""
    # https://github.com/pallets/click/blob/0aec1168ac591eREMOVED9baf6f61026d6ae322c53aaf/src/click/core.py#L2720-L2726
    if envvar is None:
        if (
...
def rich_format_help(
    *,
    ...
    https://github.com/Textualize/rich-cli/blob/8a2767c7a3407REMOVEDfc6fbf4930ace717b9b2fc5e5/src/rich_cli/__main__.py#L162-L236
