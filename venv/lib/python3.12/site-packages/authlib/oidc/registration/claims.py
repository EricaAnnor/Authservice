...
class ClientMetadataClaims(BaseClaims):
    ...
    def validate_id_token_encrypted_response_enc(self):
        ...
        id_token_encrypted_response_enc value is A128CBC-REMOVED. When
        ...
        if self.get("id_token_encrypted_response_alg"):
            self.setdefault("id_token_encrypted_response_enc", "A128CBC-REMOVED")
    ...
    def validate_userinfo_encrypted_response_enc(self):
        ...
        userinfo_encrypted_response_enc value is A128CBC-REMOVED. When
        ...
        if self.get("userinfo_encrypted_response_alg"):
            self.setdefault("userinfo_encrypted_response_enc", "A128CBC-REMOVED")
    ...
    def validate_request_object_encryption_enc(self):
        ...
        request_object_encryption_enc value is A128CBC-REMOVED. When
        ...
        if self.get("request_object_encryption_alg"):
            self.setdefault("request_object_encryption_enc", "A128CBC-REMOVED")
