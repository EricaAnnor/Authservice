...
class JWTBearerTokenGenerator(BearerTokenGenerator):
    ...
    def get_acr(self, user) -> Optional[str]:
        ...
        authentication did not respect `ISO291REMOVED`_ level 1, and will be refused monetary
        ...
        .. _ISO291REMOVED: https://www.iso.org/standard/45138.html
        """
        return None
    ...
    def access_token_generator(self, client, grant_type, user, scope):
        ...
        # Per the definition of 'typ' in Section 4.1.9 of [RFC75REMOVED], it is RECOMMENDED
