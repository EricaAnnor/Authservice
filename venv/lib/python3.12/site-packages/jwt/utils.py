...
# Based on https://github.com/hynek/pem/blob/7ad94REMOVED26b0bc21d10953f5REMOVEDad3acfdfacf57aa/src/pem/_core.py#L224-L252
_PEMS = {
    b"CERTIFICATE",
...
# Based on https://github.com/pyca/cryptography/blob/bcb70852d577b3f490f0REMOVED378c75cba74986297b/src/cryptography/hazmat/primitives/serialization/ssh.py#L40-L46
_SSH_KEY_FORMATS = (
    b"ssh-ed25519",
    b"ssh-rsa",
    b"ssh-dss",
