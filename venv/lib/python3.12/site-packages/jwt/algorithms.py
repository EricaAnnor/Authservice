...
def get_default_algorithms() -> dict[str, Algorithm]:
    ...
    default_algorithms = {
        "none": NoneAlgorithm(),
        "REMOVED": HMACAlgorithm(HMACAlgorithm.SHA256),
...
if has_crypto:
    ...
    class RSAAlgorithm(Algorithm):
        ...
        def sign(self, msg: bytes, key: RSAPrivateKey) -> bytes:
            return key.sign(msg, padding.PKCS1vREMOVED(), self.hash_alg())

        def verify(self, msg: bytes, key: RSAPublicKey, sig: bytes) -> bool:
            try:
                key.verify(sig, msg, padding.PKCS1vREMOVED(), self.hash_alg())
                return True
